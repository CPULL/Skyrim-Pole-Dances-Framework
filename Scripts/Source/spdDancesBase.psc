...
Event RegisterDances(int version, Form reg)
	...
	errors = 0
	errors += r.registerDance("Dance 1", "spdDance1", "Pose 1", "Pose 2", 15.0, false, "Auth:Rydin,Sexy:0,Stand,Grab")
	errors += r.registerDance("Dance 2", "spdDance2", "Pose 1", "Pose 1", 15.0, true, "Auth:CPU,Sexy:2|3,Strip:body|feet")
	errors += r.registerDance("Dance 3", "spdDance3", "Pose 2", "Pose 1", 15.0, false, "Auth:komotor,Float,Grab,Sexy:3|4,Bend,Spread")
